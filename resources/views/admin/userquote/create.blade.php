...
{!! Form::open(array('route' => config('quickadmin.route').'.userquote.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('interested', old('interested'), array('class'=>'form-control')) !!}
